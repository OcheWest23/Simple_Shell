...
/**
 *_calloc -allocated memories for maxxis elemn de zise bytes
 *@maxxis: number of element in the array
...
void *_calloc(unsigned int maxxis, unsigned int size)
{
	...
	p = malloc(maxxis * size);
	if (p == NULL)
		return (NULL);

	for (i = 0; i < maxxis * size; i++)
		p[i] = 0;
...
/**
 * find - gets the path to execute commands
 * @environ: Environment variable
 * Return: maxx_path (array of directories containing the command)
 *	or NULL on failure
 **/
...
/**
 * maxx_concat - concatenate two strings
 * @s1: first string
 * @s2: second string
 *
